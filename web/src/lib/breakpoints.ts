// breakpoints.ts — a CodeMirror 6 extension: a clickable breakpoint gutter plus
...
export const setStopLineEffect = StateEffect.define<number | null>()
...
export function breakpointGutter(onToggle?: (line: number, lines: number[]) => void): Extension[] {
  return [
    bpField,
    gutter({
