<!-- Generated from ROADMAP.md by scripts/sync-docs.mjs — edit the source, not this file. -->
...
[README.md](https://github.com/vul-os/wede/blob/main/README.md#features) for the authoritative, user-facing list):
...
- An **editor** share link grants an unsandboxed login shell on the host (see
  [docs/ARCHITECTURE.md](#architecture:no-sandbox-warning-for-shared-deployments));
  treat any change touching auth/roles/path-confinement as security-sensitive
  and add a regression test.
- See [CHANGELOG.md](#changelog) for what has actually shipped, release by
  release.
