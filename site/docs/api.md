<!-- Generated from docs/API.md by scripts/sync-docs.mjs — edit the source, not this file. -->
...
[SECURITY-HARDENING.md](#security-hardening) and
[ARCHITECTURE.md § 6](#architecture).
...
[SECURITY-HARDENING.md](#security-hardening) before granting editor access.
...
`<wede>/environments/`. See [SECURITY-HARDENING.md § 10](#security-hardening)
