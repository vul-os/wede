<!-- Generated from docs/PUBLIC-ACCESS.md by scripts/sync-docs.mjs — edit the source, not this file. -->
...
[CONFIGURATION.md](#configuration)) — the reverse proxy above already keeps
...
See [GETTING-STARTED.md § Public internet — a sovereign Ephor](#getting-started:3-public-internet--a-sovereign-ephor)
...
- Already run Vulos OS? Use [embedding](#getting-started:2-through-vulos--no-public-exposure) instead — no public exposure needed at all.
