<!-- Generated from docs/SECURITY-HARDENING.md by scripts/sync-docs.mjs — edit the source, not this file. -->
...
Everything here is also mentioned somewhere in [README.md](#overview),
[GETTING-STARTED.md](#getting-started), [CONFIGURATION.md](#configuration),
[PUBLIC-ACCESS.md](#public-access), or [ARCHITECTURE.md](#architecture) —
...
- **wede's own listener is plain HTTP.** `backend/cmd/wede/main.go` calls
  ...
  (see [PUBLIC-ACCESS.md](#public-access) option (a)), or the built-in
...
wide open — see [PUBLIC-ACCESS.md](#public-access).
...
[PUBLIC-ACCESS.md](#public-access). If your proxy forwards WebSocket
...
the config's password. See [PUBLIC-ACCESS.md](#public-access) for what the
