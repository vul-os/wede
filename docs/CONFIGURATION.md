...
a lockout that persists across restarts (see [ARCHITECTURE.md](ARCHITECTURE.md)
...
> [GETTING-STARTED.md](GETTING-STARTED.md#exposing-wede-over-a-network) and
> [PUBLIC-ACCESS.md](PUBLIC-ACCESS.md) for full options.
