...
export interface GitMergeLine {
  from: number
  to: number
}

export interface GitGraphRow extends GitCommitEntry {
  lane: number
...
export function buildGraph(entries: GitCommitEntry[] | null | undefined): GitGraphRow[] {
