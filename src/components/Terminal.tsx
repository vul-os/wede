...
export default forwardRef<TerminalHandle, TerminalProps>(function Terminal({ token, workspaceId, sessionId, visible, terminalTheme, fontSize = 13, initialCommand, onInitialRun, onTitle }, ref) {
