...
import type { useDap, DapStatus } from '../hooks/useDap'

const STATUS: Record<DapStatus, { label: string; dot: string }> = {
...
export default function DebugPanel({ dap, canDebug, targetName, targetLang, onStart, readOnly, hint }: DebugPanelProps) {
