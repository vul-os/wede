...
export default function QuickOpen({ visible, onClose, authFetch, workspaces = [], workspaceId, onOpenFile }: QuickOpenProps) {
  ...
  const roots = useMemo((): Pick<WorkspaceSummary, 'id' | 'name'>[] => (
